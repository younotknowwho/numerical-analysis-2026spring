% Homework 01. Problem 2. Analyses of cancellation (Higher Precision)
clear;
clc;
...
exportgraphics(fig, 'Cancellation_analysis_a_HigherPrecision.pdf', ...
...
% save the figure
set(gcf, 'PaperPositionMode', 'auto');
exportgraphics(fig, 'Cancellation_analysis_b_HigherPrecision.pdf', ...
    'ContentType', 'vector', 'BackgroundColor', 'none');
